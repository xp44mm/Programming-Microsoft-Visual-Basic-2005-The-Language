Public Class Triangle
    ...
    Public Function GetArea() As Double
        ' Use Heron抯 formula to calculate the area.
        Dim halfP As Double = (a + b + c) / 2
        Return Math.Sqrt(halfP * (halfP - a) * (halfP - b) * (halfP - c))
    End Function

    Public Shared Function GetPerimeter(ByVal a As Double, ByVal b As Double,
       ByVal c As Double) As Double
        Return a + b + c
    End Function

    Public Shared Function GetArea(ByVal a As Double, ByVal b As Double,
          ByVal c As Double) As Double
        Dim halfP As Double = (a + b + c) / 2
        Return Math.Sqrt(halfP * (halfP - a) * (halfP - b) * (halfP - c))
    End Function
