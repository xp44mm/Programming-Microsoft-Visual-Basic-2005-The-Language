...
Module MainModule
   ...
   Sub VersionToleranteDeserialization()
      '--------------------------------------------------------------------------
      ' WARNING: this code requires that you manually copy the BOLibrary.dll file
      ' from the output directory of project BOLibrary_v10 into the output library
      ' of current project, and rename this DLL as BOLibrary_v10.dll
      '--------------------------------------------------------------------------

      ' Serialize an instance of Customer from BOLibrary version 1.0
      Dim asmFile As String = Directory.GetCurrentDirectory() & "\BOLibrary_v10.dll"
      ' ensure that this file exists
      If Not File.Exists(asmFile) Then Stop
