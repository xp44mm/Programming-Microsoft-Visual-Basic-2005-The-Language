...
Partial Class PropertiesForm
    ...
    Private Sub InitializeComponent()
      ...
      Me.ToolTip1.SetToolTip(Me.chkEcmaScript, "Enables ECMAScript-compliant behavior. §This flag can be used only in conjunction" & _
      ...
      Me.ToolTip1.SetToolTip(Me.chkCultureInvariant, "Uses the culture implied by CultureInfo.InvariantCulture, instead of §the locale " & _
      ...
      Me.ToolTip1.SetToolTip(Me.chkRightToLeft, "Specifies that the search is from right to left §instead of from left to right. I" & _
              "f a starting index is specified, §it should point to the end of the string. ")
      ...
      Me.ToolTip1.SetToolTip(Me.chkExplicitCapture, "Captures only explicitly named or numbered groups §of the form (?<name>) so that " & _
              "naked parentheses act as noncapturing §groups without your having to use the (?:" & _
              ") construct.")
      ...
      Me.ToolTip1.SetToolTip(Me.chkCompiled, "Compiles the regular expression and generates MSIL code; §this option generates f" & _
      ...
      Me.ToolTip1.SetToolTip(Me.chkMultiline, "Multiline mode; changes the behavior of §^ and $ so that they match the beginning" & _
              " and end of individual lines, respectively, §instead of the whole string.")
      ...
      Me.ToolTip1.SetToolTip(Me.chkIgnoreWhitespace, "Ignores unescaped white space from the pattern and §enables comments marked with " & _
              "#. Significant spaces §in the pattern must be specified as [ ] or \x20.")
      ...
      Me.ToolTip1.SetToolTip(Me.txtDescription, "The free-format description of the regular expression.§Can be used to generate co" & _
              "mments in code.")
      '
      'Label2
      '
      ...
      Me.ToolTip1.SetToolTip(Me.txtName, "The name of the regular expression. §It is used when the expression is compiled.")
      '
      'Label1
      '
      ...
      Me.ToolTip1.SetToolTip(Me.chkIncludeEmptyGroups, "If selected, groups are included in results §even if they match an empty string.")
      ...
      Me.ToolTip1.SetToolTip(Me.cboFormat, "Sets the format used to display results. §Results are displayed either in a treev" & _
              "iew or a textbox. §By default, the Find command uses the treeview, all other com" & _
